...
class AtomsInfo(object):
    ...
    def getPos(self):
        return self.__pos__
    #################################
    def update(self, index_g, globalIndex=False):
        if globalIndex:
            self.__globalIndex__ = index_g
    ...
    def outputInfo(self):
        ...
        str1 = '{:>7}{:>7}{:>8}{:>8}{:>8}{:>8}'.format(mol, self.__atomName__, self.__globalIndex__, posX, posY, posZ)
        return str1